...
/**
 * Description of NavigationLayout
 *
 * @author Arian Khosravi <arian@bigemployee.com>, <@ArianKhosravi>
 */
class Paginate_NavigationLayout implements Paginate_Layout {
    ...
    public function getPagedLinks(Paginate_Paginator $paginator, $urlVariables) {
        ...
        if ($totalPages <= 1) {
            ...
            $displayCurrent = '<span class="paging-input">'.$currentPage.' of <span class="total-pages">'.$paginator->getTotalPages().'</span></span>';
